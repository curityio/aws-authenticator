...
public class CallbackRequestHandler
    ...
    public Optional<AuthenticationResult> get(CallbackGetRequestModel requestModel,
        ...
        Map<String, Object> tokenMap = _oauthClient.getTokens(_config.getDomain().toString() + _config.getTokenEndpoint().toString(),
                _config.getClientId(),
        ...
        AWSCognitoIdentityProvider identityProvider = AWSCognitoIdentityProviderClient.builder().build();
        GetUserRequest request = new GetUserRequest();
        request.setAccessToken(tokenMap.get(PARAM_ACCESS_TOKEN).toString());
        GetUserResult result = identityProvider.getUser(request);
